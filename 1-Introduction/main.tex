...
\textcolor{red}{The scope from the hovercraft report is only this big, but I guess we can add a few more relevant details about things that are outside of the scope (can't specifically think of anything right now...)}
\end{document}