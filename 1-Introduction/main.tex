...
A typical demining operation requires personnel to clear a path or area, ensuring it is safe for ground troops and vehicles to pass over. The mission profile developed for the platform, shown in \Figref{mission}, is based off of typical operating environments and will form the basis of many of the project's design requirements.
\todo[inline]{Relate more explicitly to the case studies from previous section}
...
\todo[inline]{In this section, explain more clearly how each performance specification satisfies the mission profile, and relates to the operating environment}
