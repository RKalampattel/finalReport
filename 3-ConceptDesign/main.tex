...
In the second set of tests, a single brass sample was scanned, with the distance to the metal detector changed between scans. The results are shown in \Figref{phaseDepths}, and while the phase angle does not vary with depth, the signal magnitude does. Based on on these tests,   it was concluded that the magnitude and phase angle of the signal would be suitable metrics for characterising objects; the phase angle can be used to identify the metal, while the magnitude provides information about the depth, size and material. Thus, the aim of the signal processing algorithm for the metal detector is to find these metrics given the metal detector input data. \todo[inline]{sounds like these were the only two tests that we did, were there any others that didnt make the cut for to be in the metrics?}
...
\centerline{
\begin{tabular}{ccc}
\subfloat[Front wheel steering]{\includegraphics[width=0.3\textwidth]{3-ConceptDesign/Detector_Coverage1.png}}
& \subfloat[Rear wheel steering]{\includegraphics[width=0.3\textwidth]{3-ConceptDesign/Detector_Coverage2.png}}
\end{tabular}}
...
\begin{figure}[ht]
\includegraphics[width=.7\textwidth]{3-ConceptDesign/basic.PNG}
\centering
\caption{Basic sensor mount design showing central wooden beam and metal supports}
\figlabel{basic}
\end{figure}
...
It was decided to encase the metal detector between two sheets of Perspex to protect the 
Also allows for the metal detector to be mounted more easily
Different concepts were developed for how to mount the metal detector. 
Designs 1 through 3
...
\tablabel{test}
\begin{tabular}{r *5c}
    \multicolumn{1}{r}{}  & \mcrot{1}{l}{45}{Design 1} & \mcrot{1}{l}{45}{Design 2} & \mcrot{1}{l}{45}{Design 3} & \mcrot{1}{l}{45}{Design 4}\\ \toprule 
    Payload & 8 & 7 & 8 & 8\\ 
...
\textcolor{red}{Add details about the perspex case for the MD, different concepts for mounting the MD. Nylon rods allow height of MD to be adjusted. Wooden supports add torsional stiffness, preventing MD from moving as much compared to nylon rods alone. }
...
\centerline{
\begin{tabular}{cc}
\subfloat[Design 1]{\includegraphics[height=0.3\textwidth]{3-ConceptDesign/square.PNG}}
& \subfloat[Design 2]{\includegraphics[height=0.3\textwidth]{3-ConceptDesign/final.PNG}}\\
\subfloat[Design 3]{\includegraphics[height=0.3\textwidth]{3-ConceptDesign/triangle.PNG}}
& \subfloat[Design 4]{\includegraphics[height=0.3\textwidth]{3-ConceptDesign/cantilever.PNG}}
\end{tabular}}
