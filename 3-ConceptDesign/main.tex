...
The selection of sensors for the project was based on the requirements from the scenario of operation. These are as follows:  \todo[inline]{Maz: need numbers for these requirements}
...
\todo[inline]{again, this isn't conceptual design, just information on the sensor we will be using}
...
\todo[inline]{why ONLY from the second channel?}
...
% \centerline{
% \begin{tabular}{cc}
% \subfloat[]{\includegraphics[width=0.4\textwidth]{3-ConceptDesign/square.PNG}}
% & \subfloat[]{\includegraphics[width=0.4\textwidth]{3-ConceptDesign/triangle.PNG}}\\
% & \subfloat[]{\includegraphics[width=0.4\textwidth]{3-ConceptDesign/cantilever.png}}\\
% \end{tabular}}
