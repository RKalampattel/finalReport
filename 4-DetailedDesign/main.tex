...
After initial tests of the metal detector data, outdoor tests were conducted in order to gather data sets for the algorithm to process and to determine the parameters the metal detector will use in further testing. Further details of these tests are referred to \Chapref{testProcedureApp}. 
...
\centering
\caption[Gear system setup]{Gear setup showing linear potentiometers in red in front of the gear actuator} \figlabel{gearSetup}
\end{figure}
