...
Testing for the positioning system was primarily undertaken inside the virtual platform (see \secref{virtualPlatform}). This was to ensure satisfactory performance of the system before live tests were undertaken.
