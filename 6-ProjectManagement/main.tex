...
this project has advanced with progress swiftly and efficiently. the initial concept proposed in the project charter was to utilise a hovercraft however a change of scope was necessary to involve different land based vehicle to ensure project completion. Project sponsorship through the DSTG was achieved whereby equipment loaning, technical assistance and funding was received. The DSTG supplied the GPR, metal detector and the quad bike as well as \$16,500 project funds. Extensive literature reviews were completed on landmine detection methods, automation software and platform systems leading to the decisions made for the scope and direction of the project. The main project direction decided through these included the decision to use sensor fusion where two sensory systems are used instead of one, the use of GPR and a metal detector, and the use of a wheeled platform. These decisions were based on research findings and group thoughts. 

With the project heavily incorporating both software and hardware system designs and development, project and team management was crucial for the timely completion of the goal and objectives. This was achieved through clear structuring of the team into required groups with each individual being assigned specific jobs and tasks within the group. Individuals were also nominated for certain systems depending on their strongest qualities. The systems encountered throughout the project included software development for the automation of the quad bike and wireless communications as well as for the sensor output signals, hardware modification and system testing for the quad bike and sensor mount frame, and whole system testing.

Modifications to the Gantt chart constructed from the Preliminary report were minor due to the workload offset from the software development. One highlight from delay in platform delivery was that advancements in software development for the automation of the platform were able to be achieved and completed ahead of schedule. Once delivery of the platform was accepted, progress was able to achieved swiftly due to the reduced software workload allowing for more focus on the quad bike. Testing of the sensors in differing soil properties and depths allowed for comprehensive knowledge of the outputs over targets. this allowed for development of the algorithms necessary to determine the probability of whether an object is a landmine or not and what type of landmine it is. 


Modifications to the detection depths highlighted in the preliminary report were necessary after sensor testing and communications with the DSTG. a maximum depth of 150mm was selected as this was the maximum testing depth used by the DSTG. further modifications to the objectives include \textcolor{red}{other things we changed in the objectives since the prelim report}


Primary objectives that were achieved for the project can be broken down into software, platform and hardware and sensor systems. for the platform and hardware, the objectives achieved were modify a platform for automation, remote control of a platform, and the  design and build a sensor mount to adhere to the sensor requirements. For the software objectives, achievements included; development of a virtual platform, wireless communication and information display in real time on a hand held device of the important platform and sensor information and automation and navigation of a platform. For the sensors, the achieved objectives include reduction in false positives, landmine identification, algorithm development for landmine detection and clutter screening.

The objectives that were unable to be completed were \textcolor{red}{oh boi}
...
If the project were to be continued, the future work that could be carried out could be to conduct full system tests in large open fields to test the platforms automation and detection abilities, incorporate software and the necessary hardware for object detection and avoidance and further sensor testing and algorithm development to make it more robust and accurate for different types of landmines.
