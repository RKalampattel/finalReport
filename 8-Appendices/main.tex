...
\caption[Packet Structure]{Breakdown of the example packet.}\tablabel{implconstraints}\\ \toprule
...
Terminus & Terminating character indicating the receipt of the full packet. \\
