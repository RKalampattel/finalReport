...
\usepackage{gensymb}		%for symbols for HArry
...
% Will move this and renumber all files when structure of final report has been decided on - RK

\subfile{3-LiteratureReview/main.tex}
\subfile{4-ConceptDesign/main.tex}		
\subfile{5-DetailedDesign/main.tex}		
\subfile{Testing/main.tex}
