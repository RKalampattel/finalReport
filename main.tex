...
\documentclass[a4paper, 12pt,draft]{report} 	% Document class, paper and font size
...
\usepackage[normalem]{ulem}	% Allows strikthrough using \sout{}
...
\hypersetup{final} 	 % COMMENT OUT WHEN NOT USING DRAFT MODE 

\begin{document}
\subfile{0-Preamble/main.tex}		
\subfile{1-Introduction/main.tex}	

%%\subfile{2-Benchmarking/main.tex}	% Has been moved to appendix
% Will remove this and rename files when structure of final report has been decided - RK
